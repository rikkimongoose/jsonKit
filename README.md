...
2. Разместите статические файлы в директории, указанной в параметре `staticFiles`.
3. Поместите JSON-файлы в директорию, указанную в параметре `jsonDirectory`.
4. Используйте указанные настройки JSONPath для обработки данных в вашей логике приложения.
## Лицензия
